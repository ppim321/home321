...
ai_message = chatbot_message_list[idx]  # LLM  서비스에 요청 결과 (가상으로 list 이용.)
...
if prompt: #is not None:
    ...
    # container = st.chat_message("user") # container 를 가져오기. role : "user" -> 입력자를 구분하기 위한 값.
    # container.write(prompt)             # container 에 글을 출력
